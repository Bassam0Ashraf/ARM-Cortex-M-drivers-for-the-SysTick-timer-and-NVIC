...
void Test_Exceptions_Settings(void)
{
    ...
    NVIC_SetPriorityException(EXCEPTION_MEM_FAULT_TYPE,EXCEPTION_PRIORITY_LEVEL_1);
    ...
    NVIC_SetPriorityException(EXCEPTION_BUS_FAULT_TYPE,EXCEPTION_PRIORITY_LEVEL_2);
    ...
    NVIC_SetPriorityException(EXCEPTION_USAGE_FAULT_TYPE,EXCEPTION_PRIORITY_LEVEL_3);
    ...
    NVIC_SetPriorityException(EXCEPTION_SVC_TYPE,EXCEPTION_PRIORITY_LEVEL_4);
    assert(((NVIC_SYSTEM_PRI2_REG & SVC_PRIORITY_MASK) >> SVC_PRIORITY_BITS_POS) == SVC_EXCEPTION_PRIORITY);

    /* Setup priority for SVC Exception */
    NVIC_SetPriorityException(EXCEPTION_DEBUG_MONITOR_TYPE,EXCEPTION_PRIORITY_LEVEL_5);
    ...
    NVIC_SetPriorityException(EXCEPTION_PEND_SV_TYPE,EXCEPTION_PRIORITY_LEVEL_6);
    ...
    NVIC_SetPriorityException(EXCEPTION_SYSTICK_TYPE,EXCEPTION_PRIORITY_LEVEL_7);
